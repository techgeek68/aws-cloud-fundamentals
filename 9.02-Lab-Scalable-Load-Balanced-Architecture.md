      ...
      <div class="row"><div class="col-md-12">
        <div class="jumbotron">
          ...
          <table class="table table-bordered">
            ...
            <tr><td>InstanceId</td><td><i><?= htmlspecialchars($instanceId ?? 'Unknown') ?></i></td></tr>
            <tr><td>Availability Zone</td><td><i><?= htmlspecialchars($az ?? 'Unknown') ?></i></td></tr>
          </table>
          <hr />
          <p>Simulated CPU burn time this request: <b><?= $loadSeconds ?>s</b></p>
          <p>This page auto refreshes every 5 seconds to simulate a continuous load.</p>
        </div>
      </div></div>
    </div>
  </body>
