...
**CapEx:**
  - Requires upfront investment in servers, storage, and networking.
    
**OpEx:**
  - Ongoing costs for electricity, cooling, maintenance, and upgrades.
  - Pay only for what you use, no hardware investments.
...
- Google Workspace example explanation
