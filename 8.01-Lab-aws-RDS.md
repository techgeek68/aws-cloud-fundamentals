...
|  |  |                                         |   |                                           | |  |
|  |  |  +-----------------------------------+  |   |  +-------------------------------------+  | |  |
|  |  |  | Public-subnet-01 (10.0.0.0/24)    |  |   |  | (no public subnet required)          |  | |  |
|  |  |  |  (Associated: Lab-public-rt)      |  |   |  |                                     |  | |  |
|  |  |  |                                   |  |   |  |                                     |  | |  |
|  |  |  |   +---------------------------+    |  |   |  |                                     |  | |  |
|  |  |  |   | EC2: DBAppServer          |    |  |   |  |                                     |  | |  |
|  |  |  |   | - Amazon Linux 2          |    |  |   |  |                                     |  | |  |
...
|  |  |                                                                                          |  |
|  |  |  +-----------------------------------+     MySQL 3306      +---------------------------+ |  |
|  |  |  | DB-subnet-01 (10.0.1.0/24)        | <------------------> | DB-subnet-02 (10.0.3.0/24)| |  |
|  |  |  | (Private, no IGW route)           |  synchronous repl.   | (Private, no IGW route)   | |  |
|  |  |  |                                   |                     |                           | |  |
|  |  |  |   +---------------------------+    |                     |  +---------------------+  | |  |
|  |  |  |   | RDS MySQL: Primary        |    |                     |  | RDS MySQL: Standby  |  | |  |
|  |  |  |   | - Multi-AZ                |    |                     |  | - Multi-AZ replica  |  | |  |
|  |  |  |   | - Public access: NO       |    |                     |  | - Public access: NO |  | |  |
|  |  |  |   +-----------+---------------+    |                     |  +----------+----------+  | |  |
|  |  |  |               | DB SG                                   |             | DB SG       | |  |
|  |  |  +---------------|------------------------------------------+-------------|--------------+ |  |
|  |  |                  v                                                        v                |  |
|  |  |   Inbound: 3306 from Web SG                                              Inbound: 3306     |  |
|  |  |   Outbound: All                                                          from Web SG       |  |
|  |  |                                                                                          |  |
|  |  +------------------------------------------------------------------------------------------+  |
|  |                                                                                              |  |
|  |  Route Tables:                                                                               |  |
